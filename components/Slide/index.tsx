    ...
    return <article className='flex flex-col'>
        ...
        <div className='py-6 px-4 flex flex-col space-y-4 md:rounded-xl md:bg-stone-800 md:border md:border-stone-700 md:-mt-14 md:ml-24 md:px-8 md:py-8 lg:px-10 lg:py-10'>
            ...
            <div className='flex flex-col space-y-1'>
                {slide.for && <p className='text-lg font-medium opacity-70'>{slide.for}</p>}
                {slide.title && <h3 className='font-medium text-2xl lg:text-3xl'>{slide.title}</h3>}
            </div>

            {/* description */}
            {slide.description && <div className='flex flex-col text-lg font-content'>
